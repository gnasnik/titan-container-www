  ...
  return (
    <header class="bg-transparent p-4 fixed top-0 left-0 w-full">
      <div class="flex justify-between items-center">
        <div class="flex items-center space-x-2 hover">
        ...
        <button class="px-4 middle py-2 bg-blue-500 text-white rounded text-xs h-12 hover:bg-op-80" onClick={onConnectWallet}>
          Connect Wallet
        </button>
      </div>
    </header>
